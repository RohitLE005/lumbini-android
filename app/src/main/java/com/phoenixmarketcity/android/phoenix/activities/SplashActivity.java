...
import com.phoenixmarketcity.android.phoenix.util.SystemUiHider;
...
public class SplashActivity extends Activity {
    ...
    Runnable mSplashTimeoutRunnable = new Runnable() {
        @Override
        public void run() {
            if (ConfigManager.getInstance().isDevelopmentMode()) {
    ...
    protected void onStart() {
        ...
        mHideHandler.postDelayed(mSplashTimeoutRunnable, AUTO_HIDE_DELAY_MILLIS);
    }
