...
import com.phoenixmarketcity.android.phoenix.activities.WalletActivity;

/**
 * Created by neeraj.nayan on 07/08/15.
 */
public class PhoenixGcmListenerService extends GcmListenerService {

    private static final String TAG = "PhoenixGcmListener";
